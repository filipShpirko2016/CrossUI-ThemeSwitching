xui.Class('App.Radio34', 'xui.Module',{
    Instance:{
        iniComponents:function(){
            ...
            host.ctl_block36.append(
                ...
                .setItems([{
                    "id" : "a",
                    "caption" : "item a",
                    "image" : "{/}App/js/App.Radio34/img/App.Radio34/accept.png"
                },{
                    "id" : "b",
                    "caption" : "item b",
                    "image" : "{/}App/js/App.Radio34/img/App.Radio34/action_delete.png"
                },{
                    "id" : "c",
                    "caption" : "item c",
                    "image" : "{/}App/js/App.Radio34/img/App.Radio34/reply.png"
                }])
                .setDock("fill")
                .setValue("a")
                .beforeUIValueSet([{
